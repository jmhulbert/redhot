...
Should we compare a binary model for healthy / dead ? I guess there are only 48 dead trees, so probably not. Plus many dead trees may be removed prior to being observed, so our numbers of dead trees are likely a huge? underestimate. 
