...
Relationships between the health of redcedar and urban environmental metrics were explored with generalized linear mixed effect models. 
...
+ Current Analyses
  + [iNaturalist Data Summaries](https://jmhulbert.github.io/redhot/analyses/inaturalist/)
  + Urban Heat
    + [All Areas GLMMs](https://jmhulbert.github.io/redhot/analyses/all-areas)
    + [Portland GLM](https://jmhulbert.github.io/redhot/analyses/portland)
    + [Tacoma GLM](https://jmhulbert.github.io/redhot/analyses/tacoma)
    + [King County GLM](https://jmhulbert.github.io/redhot/analyses/king-county)


+ List of Models
  + [All Areas Analyses](https://jmhulbert.github.io/redhot/analyses/all-areas)
    ...
    + Model 1 - Binary Health Response (healthy, unhealthy)
      + binomial.af <- glmmTMB(binary.tree.canopy.symptoms ~ dist.from.mean.af + (1|Area),data=data,family=binomial)
    + Model 2 - Binary Top Dieback (no dead top, dead top)
      + top.dieback.binomial.af <- glmmTMB(top.dieback ~ dist.from.mean.af + (1|Area),data=data,family=binomial)
    + Model 3 - Binary Thinning Response (no thinning, thinning)
      + thinning.binomial.af <- glmmTMB(thinning ~ dist.from.mean.af + (1|Area),data=data,family=binomial)
    + Co-Factors
      + Model 4 - including size and location
      ...
      + Model 6 - including location only
  ...
  + [Portland Analyses](https://jmhulbert.github.io/redhot/analyses/portland)
    + Temperature Time Series Comparison
  ...
  + [Tacoma Analyses](https://jmhulbert.github.io/redhot/analyses/tacoma)
    + Model 2 - Binary Top Dieback (no dead top, dead top)
      + top.dieback.binomial.af <- glmmTMB(top.dieback ~ DN_AF1,data=data,family=binomial)
  + [King County Analyses](https://jmhulbert.github.io/redhot/analyses/tacoma)
    + Model 2 - Binary Top Dieback (no dead top, dead top)
      + top.dieback.binomial.af <- glmmTMB(top.dieback ~ DN_AF1,data=data,family=binomial)
