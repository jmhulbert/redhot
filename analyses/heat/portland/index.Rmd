...
### Portland data with heat values cacluated after removing hoyt
...
p2 <- p + annotate(geom="rect",ymin = -Inf, ymax = Inf, 
    ...
    annotate(geom="rect",ymin = -Inf, ymax = Inf, 
              xmin = 85, xmax = 89.4, fill = alpha('#fe9929',0.5)) + 
    annotate(geom="rect",ymin = -Inf, ymax = Inf, 
          xmin = 89.4, xmax = Inf, fill = alpha('red',0.5))
p2 + annotate("text", x=82, y=.125, label= "Protect from\nDevelopment") + annotate("text", x=87.3, y=.125, label= "Provide\nExtra Care") + annotate("text", x=91.3, y=.125, label= "Most\nConcern")
```
