...
```{r}
ggplot(data.size.site.filter,aes(tree.size.simplified))+geom_histogram(stat="count")+coord_flip()+theme_bw()
```


## Model 4: health, heat, size, and location - filtered data
...
## Model 6: health, heat and location
